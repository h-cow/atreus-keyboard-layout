...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_QW] = LAYOUT( /* Qwerty */
    ...
    MT(MOD_HYPR, KC_ESC), KC_TAB, KC_LGUI,  KC_LSFT, KC_BSPC,      KC_LALT, KC_LCTL,        LT(_MD, KC_SPC),  MO(_RS), KC_MINS, KC_QUOT, MT(MOD_LGUI, KC_ENT)
  ),
  ...
  [_CH] = LAYOUT( /* Qwerty */
    KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,                      KC_Y,    KC_U,    LGUI(LSFT(KC_N)),    KC_O,    KC_P    ,
    KC_A,    KC_S,    LGUI(LALT(KC_I)),    KC_F,    KC_G,                      KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN ,
  ...
  [_DK] = LAYOUT( /* [> RAISE <] */
    ...
    KC_HASH, LGUI(LSFT(KC_4)),    LGUI(LSFT(KC_5)),   LGUI(LSFT(KC_6)), KC_DLR,                    KC_PGDN, LGUI(KC_4),    LGUI(KC_5),   LGUI(KC_6), KC_PLUS ,
