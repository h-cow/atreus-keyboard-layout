...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_SP] = LAYOUT( 
    KC_TRNS, KC_NO,   KC_NO,   KC_NO,   KC_NO,                    KC_NO,  KC_NO, KC_NO, KC_NO, KC_TRNS, 
    KC_TRNS, KC_EXLM,   KC_AT,   KC_HASH,   KC_DLR,             KC_PERC,  KC_CIRC, KC_AMPR, KC_ASTR, KC_TRNS, 
    KC_TRNS, KC_NO,   KC_NO,   KC_NO,   KC_NO,                    KC_NO,  KC_NO, KC_NO, KC_NO, KC_TRNS, 
    KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS
  ),
  ...
  [_RS] = LAYOUT( /* [> RAISE <] */
    ...
    TG(_LW), KC_INS,  KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_SPC,  KC_TRNS, KC_DOT, KC_0, KC_EQL  ),
  /*
  ...
  [_LW] = LAYOUT( /* [> LOWER <] */
    ...
    KC_NO,   KC_VOLD, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_SPC,  TO(_QW), KC_PSCR, KC_SLCK, KC_PAUS )
};
